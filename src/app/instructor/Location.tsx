        ...
        <div className=" flex flex-col md:flex-row gap-4 items-center">
          <div className="bg-primary p-8 w-full   rounded-[20px] overflow-hidden">
            ...
            <iframe
              ...
              className="object-fill rounded-[4px] sm:rounded-[12px]  w-[100%]  h-[320px] my-4"
              allowFullScreen
            ></iframe>
          ...
          <div className="md:w-[45%]">
            <h1 className="text-[22px]  font-700 text-primary py-4">
              Michael Leger’s instructing availability is:
            </h1>

            <div className="text-[14px] flex flex-row w-[full] p-[12px] bg-white text-black items-center rounded-[10px] justify-between">
            ...
            <div className="text-[14px] flex flex-row w-[full] p-[12px] bg-transparent text-black items-center rounded-[10px] justify-between">
