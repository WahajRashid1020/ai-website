          ...
          <div className="sm:mx-0 mx-[2rem]">
            ...
            <div className="flex flex-col gap-[20px]">
              ...
              <div className="bg-white rounded-[10px] p-[24px] text-primary">
                ...
                <p className="text-[18px] font-500 ml-[2rem]">
                  Mike has Private Pilot, Light Sport, Instrument and
                  Multi-Engine Licenses and can teach Private Pilot, Light
                  Sport, Instrument and Multi-Engine lessons..
                </p>
              </div>
            </div>
          </div>
